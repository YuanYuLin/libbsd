...
def MAIN_EXTRACT(args):
    ...
    ops.copyto(ops.path_join(src_lib_dir, "libbsd.so.0.8.3"), dst_lib_dir)
    ops.ln(dst_lib_dir, "libbsd.so.0.8.3", "libbsd.so.0.8")
    ops.ln(dst_lib_dir, "libbsd.so.0.8.3", "libbsd.so.0")
    ops.ln(dst_lib_dir, "libbsd.so.0.8.3", "libbsd.so")
    return True
